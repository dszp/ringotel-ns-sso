...
export function buildDeps(config: Config, fetchImpl: typeof fetch = fetch): AuthorizeDeps {
  ...
  const read = new RingotelReadClient({ token: config.ringotelToken, injectOrgId: false, fetchImpl });
